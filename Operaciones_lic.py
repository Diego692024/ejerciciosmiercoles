...
def registrar_csv (fila, ruta):
    ...
    id = int(id)
    id += 1
    #id=int(data[-1]["id"])+1 otra forma los 3 en una fila
    fila["id"]= id 
...
#fieldnames cada columna del csv 
# obtener id 
# en data esta mi lista de todas mis filass, obtengo el ultimo con data[-1]
